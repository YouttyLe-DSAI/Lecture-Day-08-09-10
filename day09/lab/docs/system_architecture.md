...
| Latency | 1 LLM call (~2s) | 2-3 worker calls (~5-6s) nhưng trace rõ hơn |
...
3. **Embedding model all-MiniLM-L6-v2 là general-purpose** — chưa fine-tune cho Vietnamese text. Một số câu hỏi tiếng Việt có thể retrieve sai chunk.
